...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-100 border-t border-gray-200 py-8 text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <nav className="mt-2">
          <Link to="/privacy" className="text-gray-500 hover:text-gray-700 mx-2">Privacy Policy</Link>
          <span className="text-gray-400">|</span>
          <Link to="/terms" className="text-gray-500 hover:text-gray-700 mx-2">Terms of Service</Link>
        </nav>
      </div>
    </footer>
  );
